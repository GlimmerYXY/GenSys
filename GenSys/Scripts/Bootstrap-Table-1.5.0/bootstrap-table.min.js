        ...
        h.DEFAULTS = {
            ...
            h.prototype.initHeader = function () {
                ...
                this.header = {
                    ...
                    !this.options.showHeader || this.options.cardView ? (this.$header.hide(), this.$container.find(".fixed-table-header").hide(), this.$loading.css("top", 0)) : (this.$header.show(), this.$container.find(".fixed-table-header").show(), this.$loading.css("top", "37px")),
            ...
            h.prototype.initToolbar = function () {
                ...
                this.$toolbar = this.$container.find(".fixed-table-toolbar").html(""),
                    ...
                    this.options.showRefresh && f.push(b('<button class="btn btn-default" type="button" name="refresh" title="%s">', this.options.formatRefresh()), '<i class="glyphicon glyphicon-refresh icon-refresh"></i>', "</button>"),
                    this.options.showToggle && f.push(b('<button class="btn btn-default" type="button" name="toggle" title="%s">', this.options.formatToggle()), '<i class="glyphicon glyphicon glyphicon-list-alt icon-list-alt"></i>', "</button>"),
                    this.options.showColumns && (f.push(b('<div class="keep-open btn-group" title="%s">', this.options.formatColumns()), '<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">', '<i class="glyphicon glyphicon-th icon-th"></i>', ' <span class="caret"></span>', "</button>", '<ul class="dropdown-menu" role="menu">'), a.each(this.options.columns,
                        function (a, c) {
                    ...
                    this.options.showColumns && (c = this.$toolbar.find(".keep-open"), h <= this.options.minimumCountColumns && c.find("input").prop("disabled", !0), c.find("li").off("click").on("click",
                        function (a) {
                            a.stopImmediatePropagation()
                        }), c.find("input").off("click").on("click",
                            function () {
                                var b = a(this);
                                e.toggleColumn(b.val(), b.prop("checked"), !1),
                                    e.trigger("column-switch", a(this).data("field"), b.prop("checked"))
                            })),
                    this.options.search && (f = [], f.push('<div class="pull-' + this.options.searchAlign + ' search">', b('<input class="form-control" type="text" placeholder="%s">', this.options.formatSearch()), "</div>"), this.$toolbar.append(f.join("")), d = this.$toolbar.find(".search input"), d.off("keyup").on("keyup",
                        function (a) {
                            clearTimeout(g),
            ...
            h.prototype.initPagination = function () {
                if (this.$pagination = this.$container.find(".fixed-table-pagination"), this.options.pagination) {
                    ...
                    m.push('<li class="page-next"><a href="javascript:void(0)">&gt;</a></li>', '<li class="page-last"><a href="javascript:void(0)">&gt;&gt;</a></li>', "</ul>", "</div>"),
                        ...
                        this.options.smartDisplay && (this.totalPages <= 1 && this.$pagination.find("div.pagination").hide(), (this.options.pageList.length < 2 || this.options.totalRows <= this.options.pageList[1]) && this.$pagination.find("span.page-list").hide(), this.$pagination[this.getData().length ? "show" : "hide"]()),
                    ...
                    h.push("<tr", b(" %s", o.join(" ")), b(' id="%s"', a.isArray(k) ? void 0 : k._id), b(' class="%s"', l.classes || (a.isArray(k) ? void 0 : k._class)), b(' data-index="%s"', j), ">"),
                        ...
                        a.each(this.header.fields,
                            function (a, d) {
                                ...
                                } else i = "undefined" == typeof i || null === i ? e.options.undefinedText : i,
            ...
            h.prototype.initServer = function (b) {
                ...
                this.options.url && ("limit" === this.options.queryParamsType && (e = {
                    ...
                    success: function (a) {
                        ...
                        var b = a;
                        "server" === c.options.sidePagination && (c.options.totalRows = a.total, b = a.rows),
                            c.load(b),
        ...
        a.fn.bootstrapTable = function (b, c) {
            ...
            return this.each(function () {
                var e = a(this),
                    ...
                    g = a.extend({},
                        h.DEFAULTS, e.data(), "object" == typeof b && b);
                if ("string" == typeof b) {
